...
def test_llm_invoke_real():
    ...
    llm = SarvamLLM(model='sarvam-30b')
...
def test_llm_with_temperature_real():
    ...
    llm = SarvamLLM(model='sarvam-30b', temperature=0.3)
...
def test_chat_with_reasoning_effort_real():
    ...
    chat = SarvamChat(model='sarvam-30b', reasoning_effort="medium", temperature=0.5)
...
def test_hindi_language_support_real():
    ...
    chat = SarvamChat(model='sarvam-30b', temperature=0.3)
...
def test_llm_with_wiki_grounding_real():
    ...
    llm = SarvamLLM(model='sarvam-30b', wiki_grounding=True, temperature=0.2)
